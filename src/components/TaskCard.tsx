...
function TaskCard({task,deleteTask,updateTask} :props) {
 ...
 useSortable({
  ...
  const style ={
    ...
    if(isDragging){
        return <div ref={setNodeRef} style={style} className="bg-mainBackgroundColor p-2.5 h-[100px] min-h-[100px] items-center flex text-left rounded-xl border-rose-500 border-2 cursor-grab relative opacity-30" ></div>
    }
